...
Note: For each assignment, provide explanations in markdown cells describing the steps and purpose of each part of the code. Submit the assignments as .ipynb files with visualization outputs.
